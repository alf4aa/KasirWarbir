...
public interface DbSchema {
	...
	String INSERT_TBL_USER = " INSERT INTO " + TBL_USER + " VALUES('"+ Shared.getUserID() +"','alfa','"+ Shared.getMD5("1234") +"',1,'2016-09-16 01:01:01','"+ Shared.read(Constants.KEY_SETTING_CASHIER_ID,"") +"');" ;
